...
public class DtsTraceMessageUtility {
    ...
    // io.airbyte.protocol.models.v0.DtsTraceMessage
    // & the tech spec:
    ...
    private static DtsMessage makeDtsMessageFromTraceMessage(final DtsTraceMessage airbyteTraceMessage) {
        return new DtsMessage().withType(Type.TRACE).withTrace(airbyteTraceMessage);
    }
