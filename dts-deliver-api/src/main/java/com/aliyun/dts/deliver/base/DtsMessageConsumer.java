 ...
 * class.
 */
public interface DtsMessageConsumer extends CheckedConsumer<List<DtsMessage>, Exception>, AutoCloseable {
     ...
     *
     * @param message {@link DtsMessage} to be processed
     * @throws Exception
     */
    @Override
    void accept(List<DtsMessage> message) throws Exception;
