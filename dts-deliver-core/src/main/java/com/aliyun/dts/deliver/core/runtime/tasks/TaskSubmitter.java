...
public class TaskSubmitter {
    ...
    //todo(yanmen)
    public Optional<MemoryRecordStore> getRecordStore() {
    ...
    public void submitSinkTask(AbstractRecordStoreWithMetrics recordStore, Destination destination, DtsMessagePipeline messagePipeline, int groupKey) {
        SinkTask task = new IncrementSinkTask(this.settings, destination, recordStore, messagePipeline, groupKey);
        task.setContext(context);
        submitNormalTask(task);
    }
}
