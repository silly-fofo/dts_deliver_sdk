...
public class DtsDeliver {
    ...
    public DtsDeliver(JobConfig jobConfig, Source source) {
    ...
    public DtsDeliver(JobConfig jobConfig, Source source, Destination destination) {
        this.jobConfig = jobConfig;
        this.source = source;
        this.destination = destination;
    }
    ...
    private void doDeliver() {
        DtsIntegrationRunner integrationRunner = new DtsIntegrationRunner(settings, coreMetrics, destination, source, standaloneContext.getDefaultContext());
